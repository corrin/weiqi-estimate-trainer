"""Phase 3: Batch-analyze every qualifying turn of every game for predictive positions.
Resumable. One KataGo query per batch of 50 turns.

Usage: python phase3_analyze.py [--max GAMES] [--visits V]
"""
...
def main():
    ...
    parser.add_argument('--visits', type=int, default=500, help='KataGo visits per turn')
